...
export const NumbertoWordsConvComponent = () => {
    ...
    useEffect(() => {
        if (number) {
            ...
            if (!isNaN(num)) {
                if(num < 0) {
                    // Negative values are auto handled as positive
                    setNumber(Math.abs(num).toString());
                }
                        ...
                        <Card.Body>
                            <Form>
                                <Form.Group controlId="formNumber">
                                    <Form.Label>Enter a Number (Negative values are auto converted to positive values)</Form.Label>
                                    <Form.Control
                                        type="text"
